        ...
        for e in p.GetGoodEventsForSignal():
            ...
            if 'topPt' in flags:
                if flags['topPt'] == "nominal":
                    w_top_pt = branches.topPtWeight
                elif flags['topPt'] == "up":
                    w_top_pt = branches.topPtWeightUp
                elif flags['topPt'] == "down":
                    w_top_pt = branches.topPtWeightDown
