...
for label, path in datasets:
    ...
    if label.endswith('2015D_PR') or label.endswith('2015D_Oct05'):
        mask = 'https://cms-service-dqm.web.cern.ch/cms-service-dqm/CAF/certification/Collisions15/13TeV/Cert_246908-260627_13TeV_PromptReco_Collisions15_25ns_JSON.txt'
