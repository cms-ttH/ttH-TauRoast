...
if [ $comparison -gt 0 ]; then
   ...
   scripts/cmp_trees -n -1 $syncdir/tau_tallinn_event_signal /afs/cern.ch/user/a/atiko/public/tthtotautau/sync/Summer16/sync_ntuples_split_tight.root:$tree:Tallinn test/sync_tau/out/ntuple_mva.root:$tree:ND &
