...
scripts/cmp_trees -n 100 $syncdir/tau_llr $syncdir/syncNtuple_ttH_80X.root:syncTree:LLR test/sync_tau/out/ntuple.root:syncTree:ND
scripts/cmp_trees -n -1 $syncdir/tau_llr_event $syncdir/syncNtuple_event_ttH_80X.root:syncTree_1l2tau:LLR test/sync_tau/out/ntuple.root:syncTree_1l2tau:ND
