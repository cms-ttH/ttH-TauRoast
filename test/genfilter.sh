...
cmsRun test/ntuplize.py inputFiles_load=file:test/genfilter.files outputFile=test/genfilter/ttjets_filtered/test.root channels=ttl maxEvents=$MAXEVENTS genFilter=true genFilterWithFakes=true &
