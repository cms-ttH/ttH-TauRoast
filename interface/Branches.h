...
namespace roast {
    class Branches {
        ...
        public:
            ...
            std::vector<int>* J_PartonGrandmother01Status;
            std::vector<int>* J_PartonGrandmother10Id;
            std::vector<int>* J_PartonGrandmother10Status;
            std::vector<int>* J_PartonGrandmother11Id;
            std::vector<int>* J_PartonGrandmother11Status;
            std::vector<int>* J_PartonId;
            std::vector<int>* J_PartonMother0Id;
